    ...
    <>
      ...
      {status != "authenticated" ? (
        <div className="w-full h-screen flex flex-col gap-3 items-center justify-center">
          <p className="text-gray-300 text-xl"> Necessário fazer login.</p>
          <Link href={"/authentication/signin"} className="w-[40%] btn text-white py-2 px-5 rounded-md flex items-center justify-center">
