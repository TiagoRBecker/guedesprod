          ...
          <div className="flex flex-col container mx-auto">
            ...
            {status ? (
              ...
              <p className="text-center w-[80%] mx-auto text-xl text-gray-500">
                ...
                sucesso. Os documentos relacionados à sua compra serão enviados
                para o seu e-mail <strong>{message}</strong> dentro de até 5
                minutos. Por favor, verifique tanto a sua caixa de entrada
                quanto a pasta de spam para garantir que você receba os
                documentos sem problemas. Caso tenha alguma dúvida ou necessite
                de assistência adicional, não hesite em nos contatar.
