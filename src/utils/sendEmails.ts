...
export const SendEmailDoc = async (data:any,procuts:any)=>{
                                        ...
                                        >
                                          <tr>
                                            ...
                                            >
                                              <img
                                                title="Facebook"
                                                src="https://ehhfpia.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png"
                                                alt="Fb"
                                                width="32"
                                                height="32"
                                                style="
                                            ...
                                            >
                                              <img
                                                title="Twitter"
                                                src="https://ehhfpia.stripocdn.email/content/assets/img/social-icons/logo-black/twitter-logo-black.png"
                                                alt="Tw"
                                                width="32"
                                                height="32"
                                                style="
                                            ...
                                            >
                                              <img
                                                title="Instagram"
                                                src="https://ehhfpia.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png"
                                                alt="Inst"
                                                width="32"
                                                height="32"
                                                style="
                                            ...
                                            >
                                              <img
                                                title="Youtube"
                                                src="https://ehhfpia.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png"
                                                alt="Yt"
                                                width="32"
                                                height="32"
                                                style="
